...
public class LChessBoardUnit : Control
{
	...
	public static readonly DependencyProperty LChessTileColorTypeProperty =
		DependencyProperty.Register(nameof(LChessTileColorType), typeof(ChessTileColorType), typeof(LChessBoardUnit), new FrameworkPropertyMetadata(ChessTileColorType.LightCyan));
